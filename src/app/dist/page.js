    ...
    return (React.createElement("div", { className: "flex justify-center mt-4 w-full" },
        React.createElement("div", { className: "w-full" },
            React.createElement("div", { className: "w-[85%] mx-auto" },
                ...
                React.createElement("div", { className: " grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4  mx-auto " }, books === null || books === void 0 ? void 0 : books.map(function (book) { return (React.createElement(Books_1["default"], { key: book.id, book: book, updateBookStatus: updateBookStatus, deleteBook: deleteBook })); }))))));
}
