...
function MyBooks() {
        ...
        var fetchBooks = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        filteredData = data.filter(function (book) { return book.isReading === true; });
    ...
    return (React.createElement("div", { className: "flex justify-center mt-4 w-full" },
        React.createElement("div", { className: "w-full" },
            React.createElement("div", { className: "w-[85%] mx-auto" }, books === null || books === void 0 ? void 0 : books.map(function (book) { return (React.createElement(MyBook_1["default"], { key: book.id, book: book })); })))));
}
