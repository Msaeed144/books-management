...
const Books: React.FC<BooksProps> = ({ book, updateBookStatus }) => {
  return (
    <div className="text-center min-w-[150px] max-w-[150px] border rounded-md border-gray-300 px-2 py-4 bg-gray-50 shadow-xl flex flex-col">
